...
public class ProductEndPoint {
    ...
    /**
     *
     * Payload root defines an handler method, by using the general base
     ...
     *
     * See
     * http://docs.spring.io/spring-ws/site/apidocs/org/springframework/ws/server/endpoint/annotation/PayloadRoot.html
     *
     */
