...
public class UserController {
    ...
    public String bar(
            @RequestParam(required=false) String c, // URL parameter "a", required
            @RequestParam int d, // URL parameter "b", required
            @RequestParam Boolean e, // URL parameter "c", required
            Model model
    ) {
